    ...
    <>
      ...
      {!isOnline && (
        <div className='fixed bottom-20 left-1/2 z-50 -translate-x-1/2 transform animate-fade-in-up'>
          <div className='flex items-center gap-2 rounded-lg bg-yellow-500/95 px-4 py-2 text-sm font-medium text-white shadow-lg backdrop-blur-sm'>
      ...
      {isInstalled && (
        <div className='fixed bottom-20 left-1/2 z-50 -translate-x-1/2 transform rounded-lg bg-blue-500 px-4 py-2 text-sm font-medium text-white shadow-lg animate-fade-in-up'>
