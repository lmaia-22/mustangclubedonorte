    ...
    return(
        <footer>
            ...
            <BlurFade delay={BLUR_FADE_DELAY}>
                ...
                <BlurFade delay={BLUR_FADE_DELAY}>
                    <div className="flex flex-col sm:flex-row items-center sm:justify-between rounded-md border-neutral-700/20 py-4 px-8 gap-2">
                        ...
                        <span className="text-sm text-gray-500 text-center dark:text-gray-400 mb-8">Copyright © 2024 
